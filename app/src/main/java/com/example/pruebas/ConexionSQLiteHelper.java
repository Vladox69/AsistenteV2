...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    //SNACKS
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('GALLETAS AMOR','SNACK')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('DORITOS','SNACK')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('GALLETAS OREO','SNACK')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('COCA COLA','SNACK')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('GOMINAT DE TIBURÓN','SNACK')");
     //PECES
     ...
     //LEGUMBRES
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('FREJOL','LEGUMBRE')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('ARVEJA','LEGUMBRE')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('CACAHUATE','LEGUMBRE')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('SOJA','LEGUMBRE')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('LENTEJA','LEGUMBRE')");
     //LACTEOS
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('LECHE','LACTEO')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('YOGURT','LACTEO')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('QUESO','LACTEO')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('CREMA DE LECHE','LACTEO')");
        db.execSQL("INSERT INTO PRODUCTOS (NOM_PRO,CAT_PRO) VALUES('MANTEQUILLA','LACTEO')");
    }
